...
secretario = Secretario("Baldu", "@Balducci_Fer", "1234", "Fernando Balducci", "45")
jefe1 = Jefe("Naudios", "@Andre_Nau", "1234" ,"Andrés Naudi", "50",  academica)
jefe2 = Jefe("Greatel", "@Gretel_Ram", "1234" , "Gretel Ramirez", "47" , extension)
